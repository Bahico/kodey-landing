      ...
      <div className="container text-white max-w-4xl mx-auto px-4">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="mb-4">
            ...
            No152-ФЗ «О персональных данных» (далее – ФЗ-152).
          </p>
          <p className="mb-4">
            Настоящая Политика определяет порядок обработки персональных данных
            и меры по обеспечению безопасности персональных данных в ООО "65
            Гигабайт" (далее – Оператор) с целью защиты прав и свобод человека и
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              ...
              этих целей, при невозможности устранения Оператором допущенных
          ...
          <p className="mb-3">
            Оператор производит обработку персональных данных при наличии хотя
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              ...
              данных либо жизни, здоровья или иных жизненно важных интересов
              других лиц и получение согласия субъекта персональных данных
              невозможно;
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            незамедлительно прекращена, если устранены причины, вследствие
            которых осуществлялась их обработка, если иное не установлено
            федеральным законом. Обработка персональных данных о судимости может
            осуществляться Оператором исключительно в случаях и в порядке,
          ...
          <p className="mb-4">
            ...
            персональных данных, предусмотренные ФЗ-152.
          </p>
          ...
          <p className="mb-3">
            ...
            может быть дано субъектом персональных данных или его представителем
          ...
          <p className="mb-3">
            ...
            субъекта персональных данных. Указанная обработка персональных
            данных признается осуществляемой без предварительного согласия
            субъекта персональных данных, если Компания не докажет, что такое
          ...
          <p className="mb-3">
            ...
            случаев, предусмотренных федеральными законами, или при наличии
          ...
          <p className="mb-3">
            ...
            данным Оператором применяются следующие организационно-технические
            меры:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-1">
            <li>
            ...
            <li>
              ...
              законодательства и нормативных документов Оператора по обработке и
          ...
          <p className="mb-3">
            Иные права и обязанности Оператора, как оператора персональных
          ...
          <p className="mb-3">
            ...
            персональных данных» № 152-ФЗ от 27.07.2006 г., Пользователь сайта
            https://65apps.com, даю согласие ООО «65 Гигабайт», 426077, УР, г.
            Ижевск ул. Пушкинская, 165, оф. 159-183 на обработку моих
            персональных данных в целях:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-1">
            <li>
              обеспечения обработки заявок на обратную связь с пользователем.
            </li>
          </ul>
          <p className="mb-3">
          ...
          <p className="mb-3">
            И другие персональные данные Пользователя, которые ООО «65 Гигабайт»
            может получить во время использования https://65apps.com.
          </p>
          <p className="mb-3">
            Под обработкой персональных данных я понимаю любое действие
            (операция) или совокупность действий (операций), совершаемых с
            использованием средств автоматизации или без использования таких
            средств с персональными данными, включая сбор, запись,
            систематизацию, накопление, хранение, уточнение (обновление,
          ...
          <p className="mb-3">Настоящее согласие выдано на срок пяти лет.</p>
          <p className="mb-6">

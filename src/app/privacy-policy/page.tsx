        ...
        <div className="bg-black pb-40 mb-[-100px] pt-40 flex justify-center w-full">
            <div className="container text-white max-w-4xl mx-auto px-4">
                <div className="prose prose-invert prose-lg max-w-none">
                    <h1 className="text-2xl font-bold mb-6">ПОЛИТИКА КОМПАНИИ В ОТНОШЕНИИ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h1>
                    ...
                    <p className="mb-4">
                        Настоящая Политика определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных в ООО "65 Гигабайт" (далее – Оператор) с целью защиты прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
                    </p>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl font-semibold mb-4">2. ПРИНЦИПЫ И УСЛОВИЯ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
                    
                    <h3 className="text-lg font-semibold mb-3">2.1 Принципы обработки персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-3">2.2 Условия обработки персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-3">2.3 Конфиденциальность персональных данных</h3>
                    <p className="mb-4">
                        Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.
                    </p>

                    <h3 className="text-lg font-semibold mb-3">2.4 Общедоступные источники персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-3">2.5 Специальные категории персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-3">2.6 Биометрические персональные данные</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-lg font-semibold mb-3">2.7 Поручение обработки персональных данных другому лицу</h3>
                    <p className="mb-4">
                        Оператор вправе поручить обработку персональных данных другому лицу с согласия субъекта персональных данных, если иное не предусмотрено федеральным законом, на основании заключаемого с этим лицом договора. Лицо, осуществляющее обработку персональных данных по поручению Оператора, обязано соблюдать принципы и правила обработки персональных данных, предусмотренные ФЗ-152.
                    </p>

                    <h3 className="text-lg font-semibold mb-3">2.8 Трансграничная передача персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h2 className="text-xl font-semibold mb-4">3. ПРАВА СУБЪЕКТА ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
                    
                    <h3 className="text-lg font-semibold mb-3">3.1 Согласие субъекта персональных данных на обработку его персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-3">3.2 Права субъекта персональных данных</h3>
                    <p className="mb-3">
                    ...
                    <h2 className="text-xl font-semibold mb-4">4. ОБЕСПЕЧЕНИЕ БЕЗОПАСНОСТИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
                    <p className="mb-3">
                    ...
                    <h2 className="text-xl font-semibold mb-4">5. ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ</h2>
                    <p className="mb-3">
                    ...
                    <h2 className="text-xl font-semibold mb-4">6. СОГЛАСИЕ НА ОБРАБОТКУ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
                    <p className="mb-3">
                        Настоящим во исполнение требований Федерального закона «О персональных данных» № 152-ФЗ от 27.07.2006 г., Пользователь сайта https://65apps.com, даю согласие ООО «65 Гигабайт», 426077, УР, г. Ижевск ул. Пушкинская, 165, оф. 159-183 на обработку моих персональных данных в целях:
                    </p>
                    <ul className="list-disc pl-6 mb-4 space-y-1">
                        <li>обеспечения обработки заявок на обратную связь с пользователем.</li>
                    </ul>
                    <p className="mb-3">
                    ...
                    <p className="mb-3">
                        И другие персональные данные Пользователя, которые ООО «65 Гигабайт» может получить во время использования https://65apps.com.
                    </p>
                    <p className="mb-3">
                    ...
                    <p className="mb-3">
                        Настоящее согласие выдано на срок пяти лет.
                    </p>
                    <p className="mb-6">

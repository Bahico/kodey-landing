    ...
    return (
        <section id="services" className="bg-black flex justify-center w-full pt-20 sm:pt-30 md:pt-40">
            <div className="container px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex overflow-x-auto pb-6 sm:pb-8 lg:pb-10 gap-4 sm:gap-6 md:gap-8 lg:gap-12 scrollbar-hide">
                    {services.map((service, index) => (
                        <div key={index} className={`group relative h-[400px] sm:h-[500px] md:h-[600px] lg:h-[730px] flex items-end w-[280px] sm:w-[320px] md:w-[380px] lg:w-[465px] min-w-[280px] sm:min-w-[320px] md:min-w-[380px] lg:min-w-[465px] rounded-xl sm:rounded-2xl ${service.active ? 'bg-black bg-opacity-90' : 'bg-black bg-opacity-60'}`}>
                            <div className="absolute top-0 w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[600px] flex justify-center items-center z-10">
                            ...
                            <div className="flex flex-col justify-end p-4 sm:p-6 lg:p-8 h-[280px] sm:h-[320px] md:h-[380px] lg:h-[465px] rounded-xl sm:rounded-2xl flex flex-col justify-between bg-[#0C0C0C99] group-hover:bg-[#0C0C0CE5] transition-all duration-300 card-body">
                                <div>

        ...
        <div className="overflow-visible services-container flex overflow-x-auto pb-6 sm:pb-8 lg:pb-10 gap-4 sm:gap-6 md:gap-8 lg:gap-12 scrollbar-hide">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="card-shadow p-4 sm:p-6 lg:p-8 h-[280px] sm:h-[320px] md:h-[380px] lg:h-[465px] rounded-xl sm:rounded-2xl flex flex-col justify-end bg-[#0C0C0C99] group-hover:bg-[#0C0C0CE5] transition-all duration-300 card-body">
                <div>
                  <h3

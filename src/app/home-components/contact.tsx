                ...
                <form action={sendContact} ref={formRef} className="flex flex-col w-full lg:w-2/3 relative z-2">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        <div>
                            ...
                            <textarea
                                name="description"
                                className="w-full bg-transparent border-b-2 border-gray-300 text-lg sm:text-xl md:text-2xl text-gray-800 py-2 focus:border-blue-500 outline-none resize-none"
                                rows={4}
                            ></textarea>
                        </div>
                    </div>
                        ...
                        <div className="absolute w-full h-full left-0 top-0 z-0">
                            ...
                            >
                                <mask id="path-1-inside-1_326_1060" fill="white">
                                    <path
                                        d="M268.5 -0.00488281C304.357 9.17407 319.024 17.8504 331.47 41H333V154.716C333 175.307 317.038 192 297.347 192H35.6528C15.9623 192 0.000490081 175.307 0.000488281 154.716V78.2842C0.000486481 57.6929 15.9623 41.0002 35.6528 41H259.941C271.86 28.2073 273.012 18.7464 268.5 -0.00488281Z"/>
                                </mask>
                                <path
                                    d="M268.5 -0.00488281C304.357 9.17407 319.024 17.8504 331.47 41H333V154.716C333 175.307 317.038 192 297.347 192H35.6528C15.9623 192 0.000490081 175.307 0.000488281 154.716V78.2842C0.000486481 57.6929 15.9623 41.0002 35.6528 41H259.941C271.86 28.2073 273.012 18.7464 268.5 -0.00488281Z"
                                    fill="white"
                            ...
                            >
                                <mask id="path-1-inside-1_2047_328" fill="white">
                                    <path
                                        d="M417 0.5C444.614 0.5 467 22.8858 467 50.5V135.153L565 203H50C22.3858 203 0 180.614 0 153V50.5C0 22.8858 22.3858 0.5 50 0.5H417Z"/>
                                </mask>
                                <path
                                    d="M417 0.5C444.614 0.5 467 22.8858 467 50.5V135.153L565 203H50C22.3858 203 0 180.614 0 153V50.5C0 22.8858 22.3858 0.5 50 0.5H417Z"
                                    fill="white"

  ...
  return (
    <html lang="en">
      ...
      <body className="flex flex-col items-center w-full">
        ...
        <header className="absolute top-0 left-0 w-full h-[87px] z-50 flex items-center justify-center">
          <div className="flex items-center justify-between container">
            ...
            <nav className="flex items-center gap-5">
              <a href="#" className="navbar-item flex items-center gap-2 px-8 py-4 rounded-full shadow-md transition-colors">

...
import TranslationDemo from "@/app/components/TranslationDemo";
                ...
                <div className="container px-4 sm:px-6 lg:px-8 relative">
                    ...
                    <div
                        ...
                        <div className="flex flex-col lg:gap-10 relative z-10">
                            ...
                            <h1
                                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl primary-gradient font-bold h-12 md:h-20 z-10"
                                id="title-home"
                            ></h1>

                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-gray-600 mb-4 sm:mb-6 lg:mb-8 z-10">
                                мобильных приложений
                                <br/>и цифровых сервисов
                            </h1>
                            <Link href="/#contact">
                                <button
                                    className="z-10 relative bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl text-lg sm:text-xl lg:text-2xl font-semibold hover:shadow-lg transition-shadow w-full sm:w-auto">
                                    Оставить заявку
                                </button>
                            </Link>
                        ...
                        <div className="flex-1 flex justify-center lg:justify-end pr-0 lg:pr-20 lg:order-last">
                            <div
                                ...
                                <img
                                    ...
                                    className="w-full object-cover h-full transform rotate-y-190 rounded-2xl sm:rounded-3xl lg:mr-[-40px] absolute top-0 left-0 grayscale hover:grayscale-0 transition-all duration-300"
                                    alt=""
                                />
